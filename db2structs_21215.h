...
struct BannedAddOnsRec // sizeof(0x28)
{
    DWORD field00[4]; // size 16, type 0, unk 0
...
struct ItemDisplayInfoRec // sizeof(0x30)
{
    DWORD field00[2]; // size 8, type 0, unk 0
    ...
    DWORD field14; // size 4, type 0, unk 0
    DWORD field18; // size 4, type 0, unk 0
    WORD field1C[2]; // size 4, type 5, unk 0
    WORD field20; // size 2, type 5, unk 0
    WORD field22; // size 2, type 5, unk 0
    BYTE field24[3]; // size 3, type 4, unk 0
    BYTE field27[3]; // size 3, type 4, unk 0
    BYTE field2A; // size 1, type 4, unk 4
    BYTE field2B; // size 1, type 4, unk 0
    BYTE field2C; // size 1, type 4, unk 0
};
