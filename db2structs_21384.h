...
struct BattlemasterListRec // sizeof(0x40)
{
    ...
    DWORD field08; // size 4, type 0, unk 0
    char* field0C; // size 4, type 2, unk 8
    WORD field10[16]; // size 32, type 5, unk 0
    WORD field30; // size 2, type 5, unk 0
    WORD field32; // size 2, type 5, unk 0
    BYTE field34; // size 1, type 4, unk 0
    BYTE field35; // size 1, type 4, unk 0
    BYTE field36; // size 1, type 4, unk 0
    BYTE field37; // size 1, type 4, unk 0
    BYTE field38; // size 1, type 4, unk 0
...
struct ChrClassesRec // sizeof(0x34)
{
    ...
    char* field0C; // size 4, type 2, unk 8
    char* field10; // size 4, type 2, unk 8
    char* field14; // size 4, type 2, unk 0
...
struct CreatureDifficultyRec // sizeof(0x2C)
{
    DWORD field00; // size 4, type 0, unk 0
    DWORD field04; // size 4, type 0, unk 0
    DWORD field08[7]; // size 28, type 0, unk 0
    WORD field24; // size 2, type 5, unk 4
    BYTE field26; // size 1, type 4, unk 0
    BYTE field27; // size 1, type 4, unk 0
    BYTE field28; // size 1, type 4, unk 0
...
struct CreatureDisplayInfoCondRec // sizeof(0x40)
{
    ...
    DWORD field18; // size 4, type 0, unk 4
    DWORD field1C; // size 4, type 0, unk 4
    DWORD field20[3]; // size 12, type 0, unk 4
    DWORD field2C; // size 4, type 0, unk 0
    DWORD field30[3]; // size 12, type 0, unk 0
    BYTE field3C; // size 1, type 4, unk 0
...
struct CreatureModelDataRec // sizeof(0x70)
{
    ...
    float field1C; // size 4, type 3, unk 0
    float field20; // size 4, type 3, unk 0
    float field24[6]; // size 24, type 3, unk 0
    ...
    BYTE field6A; // size 1, type 4, unk 4
    BYTE field6B; // size 1, type 4, unk 4
    BYTE field6C; // size 1, type 4, unk 4
    BYTE field6D; // size 1, type 4, unk 4
    BYTE field6E; // size 1, type 4, unk 4
    BYTE field6F; // size 1, type 4, unk 4
};
...
struct CreatureSoundDataRec // sizeof(0x58)
{
    ...
    BYTE field56; // size 1, type 4, unk 4
};
...
{
    DWORD field00[4]; // size 16, type 0, unk 4
    DWORD field10[4]; // size 16, type 0, unk 0
    float field20[2]; // size 8, type 3, unk 0
    char* field28; // size 4, type 2, unk 8
    char* field2C; // size 4, type 2, unk 8
    WORD field30; // size 2, type 5, unk 0
    WORD field32[4]; // size 8, type 5, unk 4
    WORD field3A[4]; // size 8, type 5, unk 4
    WORD field42; // size 2, type 5, unk 4
    BYTE field44[2]; // size 2, type 4, unk 4
    BYTE field46; // size 1, type 4, unk 4
    BYTE field47; // size 1, type 4, unk 4
    BYTE field48; // size 1, type 4, unk 4
};
...
struct FactionTemplateRec // sizeof(0x18)
{
    WORD field00; // size 2, type 5, unk 4
    WORD field02; // size 2, type 5, unk 4
    WORD field04[4]; // size 8, type 5, unk 4
    WORD field0C[4]; // size 8, type 5, unk 4
    BYTE field14; // size 1, type 4, unk 4
    BYTE field15; // size 1, type 4, unk 4
    BYTE field16; // size 1, type 4, unk 4
};
...
struct GarrFollowerRec // sizeof(0x34)
{
    ...
    BYTE field29; // size 1, type 4, unk 4
    BYTE field2A; // size 1, type 4, unk 4
    BYTE field2B; // size 1, type 4, unk 0
    BYTE field2C; // size 1, type 4, unk 0
    BYTE field2D; // size 1, type 4, unk 4
    BYTE field2E; // size 1, type 4, unk 4
    BYTE field2F; // size 1, type 4, unk 4
...
struct GarrMissionRec // sizeof(0x48)
{
    ...
    BYTE field3D; // size 1, type 4, unk 4
    BYTE field3E; // size 1, type 4, unk 4
    BYTE field3F; // size 1, type 4, unk 4
    BYTE field40; // size 1, type 4, unk 4
    BYTE field41; // size 1, type 4, unk 4
...
struct GarrPlotRec // sizeof(0x14)
{
    ...
    DWORD field04; // size 4, type 0, unk 0
    DWORD field08; // size 4, type 0, unk 0
    WORD field0C[2]; // size 4, type 5, unk 4
    BYTE field10; // size 1, type 4, unk 4
    BYTE field11; // size 1, type 4, unk 4
    BYTE field12; // size 1, type 4, unk 4
};
...
struct GarrTalentRec // sizeof(0x48)
{
    ...
    BYTE field44; // size 1, type 4, unk 0
    BYTE field45; // size 1, type 4, unk 0
    BYTE field46; // size 1, type 4, unk 0
};
...
struct ItemDisplayInfoRec // sizeof(0x38)
{
    ...
    DWORD field1C; // size 4, type 0, unk 0
    DWORD field20; // size 4, type 0, unk 0
    WORD field24[3]; // size 6, type 5, unk 0
    WORD field2A[2]; // size 4, type 5, unk 0
    WORD field2E; // size 2, type 5, unk 0
    WORD field30; // size 2, type 5, unk 0
    BYTE field32[3]; // size 3, type 4, unk 0
...
struct ItemSetRec // sizeof(0x50)
{
    ...
    WORD field4C; // size 2, type 5, unk 4
    BYTE field4E; // size 1, type 4, unk 4
};
...
{
    WORD field00; // size 2, type 5, unk 4
    WORD field02[3]; // size 6, type 5, unk 0
    BYTE field08; // size 1, type 4, unk 4
};

struct MapDifficultyRec // sizeof(0xC)
{
    char* field00; // size 4, type 2, unk 8
    WORD field04; // size 2, type 5, unk 4
    BYTE field06; // size 1, type 4, unk 4
...
struct QuestPOIPointCliTaskRec // sizeof(0xC)
{
    WORD field00; // size 2, type 5, unk 0
    WORD field02; // size 2, type 5, unk 0
    WORD field04; // size 2, type 5, unk 5
    WORD field06; // size 2, type 5, unk 4
    WORD field08; // size 2, type 5, unk 4
    BYTE field0A; // size 1, type 4, unk 4
};
...
{
    DWORD field00[5]; // size 20, type 0, unk 4
    DWORD field14[5]; // size 20, type 0, unk 4
    DWORD field28[5]; // size 20, type 0, unk 4
};
...
{
    WORD field00; // size 2, type 5, unk 4
    BYTE field02; // size 1, type 4, unk 0
    BYTE field03; // size 1, type 4, unk 0
};
...
{
    DWORD field00[3]; // size 12, type 0, unk 4
    char* field0C; // size 4, type 2, unk 8
    float field10[3]; // size 12, type 3, unk 0
    DWORD field1C; // size 4, type 0, unk 4
    DWORD field20; // size 4, type 0, unk 4
    DWORD field24; // size 4, type 0, unk 4
    WORD field28[3]; // size 6, type 5, unk 0
    WORD field2E; // size 2, type 5, unk 4
    WORD field30; // size 2, type 5, unk 4
    WORD field32; // size 2, type 5, unk 4
    WORD field34; // size 2, type 5, unk 4
    WORD field36; // size 2, type 5, unk 4
    BYTE field38; // size 1, type 4, unk 4
    BYTE field39[3]; // size 3, type 4, unk 4
    BYTE field3C; // size 1, type 4, unk 4
    BYTE field3D; // size 1, type 4, unk 4
    BYTE field3E; // size 1, type 4, unk 4
    BYTE field3F; // size 1, type 4, unk 0
...
struct SpellVisualColorEffectRec // sizeof(0x18)
{
    float field00; // size 4, type 3, unk 0
    DWORD field04; // size 4, type 0, unk 0
    float field08; // size 4, type 3, unk 0
...
struct SpellVisualKitModelAttachRec // sizeof(0x58)
{
    ...
    WORD field4C; // size 2, type 5, unk 0
    WORD field4E; // size 2, type 5, unk 0
    WORD field50; // size 2, type 5, unk 0
    WORD field52; // size 2, type 5, unk 4
    BYTE field54; // size 1, type 4, unk 0
    BYTE field55; // size 1, type 4, unk 4
};
...
{
    DWORD field00; // size 4, type 0, unk 5
    DWORD field04; // size 4, type 0, unk 4
    char* field08; // size 4, type 2, unk 8
    WORD field0C; // size 2, type 5, unk 4
    BYTE field0E; // size 1, type 4, unk 4
    BYTE field0F; // size 1, type 4, unk 4
    BYTE field10; // size 1, type 4, unk 4
    BYTE field11[2]; // size 2, type 4, unk 4
    BYTE field13; // size 1, type 4, unk 4
};
...
struct VehicleRec // sizeof(0x84)
{
    ...
    float field40; // size 4, type 3, unk 0
    float field44; // size 4, type 3, unk 0
    float field48[2]; // size 8, type 3, unk 0
    char* field50; // size 4, type 2, unk 0
    char* field54; // size 4, type 2, unk 0
    char* field58[2]; // size 8, type 2, unk 0
    float field60; // size 4, type 3, unk 0
    float field64; // size 4, type 3, unk 0
    WORD field68[8]; // size 16, type 5, unk 4
    WORD field78; // size 2, type 5, unk 4
    WORD field7A[3]; // size 6, type 5, unk 4
    BYTE field80; // size 1, type 4, unk 4
    BYTE field81; // size 1, type 4, unk 4
};
...
struct VehicleSeatRec // sizeof(0xCC)
{
    ...
    float field5C; // size 4, type 3, unk 0
    float field60; // size 4, type 3, unk 0
    DWORD field64; // size 4, type 0, unk 0
    DWORD field68; // size 4, type 0, unk 0
    ...
    float field7C[3]; // size 12, type 3, unk 0
    float field88; // size 4, type 3, unk 0
    float field8C; // size 4, type 3, unk 0
    float field90; // size 4, type 3, unk 0
    float field94; // size 4, type 3, unk 0
    float field98; // size 4, type 3, unk 0
    DWORD field9C; // size 4, type 0, unk 0
    ...
    WORD fieldC2; // size 2, type 5, unk 0
    WORD fieldC4; // size 2, type 5, unk 0
    BYTE fieldC6; // size 1, type 4, unk 0
    BYTE fieldC7; // size 1, type 4, unk 0
    BYTE fieldC8; // size 1, type 4, unk 0
    BYTE fieldC9; // size 1, type 4, unk 0
    BYTE fieldCA; // size 1, type 4, unk 0
    BYTE fieldCB; // size 1, type 4, unk 0
};
...
struct WorldMapAreaRec // sizeof(0x28)
{
    DWORD field00; // size 4, type 0, unk 0
    char* field04; // size 4, type 2, unk 0
    float field08; // size 4, type 3, unk 0
...
struct AreaTableRec // sizeof(0x38)
{
    ...
    BYTE field30; // size 1, type 4, unk 4
    BYTE field31; // size 1, type 4, unk 4
    BYTE field32; // size 1, type 4, unk 0
    BYTE field33; // size 1, type 4, unk 4
    BYTE field34; // size 1, type 4, unk 4
    BYTE field35; // size 1, type 4, unk 4
...
struct LightRec // sizeof(0x28)
{
    ...
    float field10; // size 4, type 3, unk 0
    WORD field14; // size 2, type 5, unk 0
    WORD field16[8]; // size 16, type 5, unk 4
};
...
struct LightDataRec // sizeof(0x70)
{
    ...
    DWORD field3C; // size 4, type 0, unk 0
    DWORD field40; // size 4, type 0, unk 0
    DWORD field44; // size 4, type 0, unk 0
    float field48; // size 4, type 3, unk 0
    float field4C; // size 4, type 3, unk 0
    float field50; // size 4, type 3, unk 0
    float field54; // size 4, type 3, unk 0
    ...
    DWORD field64; // size 4, type 0, unk 0
    DWORD field68; // size 4, type 0, unk 0
    WORD field6C; // size 2, type 5, unk 4
    WORD field6E; // size 2, type 5, unk 4
};
...
struct LiquidTypeRec // sizeof(0xA4)
{
    ...
    float field14; // size 4, type 3, unk 0
    float field18; // size 4, type 3, unk 0
    char* field1C[6]; // size 24, type 2, unk 0
    DWORD field34[2]; // size 8, type 0, unk 0
    float field3C[18]; // size 72, type 3, unk 0
    DWORD field84[4]; // size 16, type 0, unk 4
    WORD field94; // size 2, type 5, unk 4
    WORD field96; // size 2, type 5, unk 4
    BYTE field98; // size 1, type 4, unk 4
    BYTE field99; // size 1, type 4, unk 4
    BYTE field9A; // size 1, type 4, unk 4
    BYTE field9B; // size 1, type 4, unk 4
    BYTE field9C; // size 1, type 4, unk 4
    BYTE field9D[6]; // size 6, type 4, unk 4
};
...
struct MapRec // sizeof(0x38)
{
    ...
    DWORD field04[2]; // size 8, type 0, unk 0
    float field0C; // size 4, type 3, unk 0
    float field10[2]; // size 8, type 3, unk 0
    char* field18; // size 4, type 2, unk 8
    char* field1C; // size 4, type 2, unk 8
...
struct SoundKitAdvancedRec // sizeof(0x68)
{
    ...
    DWORD field54; // size 4, type 0, unk 4
    DWORD field58; // size 4, type 0, unk 4
    WORD field5C; // size 2, type 5, unk 4
    WORD field5E; // size 2, type 5, unk 4
    WORD field60; // size 2, type 5, unk 4
    BYTE field62; // size 1, type 4, unk 4
    BYTE field63; // size 1, type 4, unk 4
    BYTE field64; // size 1, type 4, unk 4
    BYTE field65; // size 1, type 4, unk 4
};
...
struct TextureBlendSetRec // sizeof(0x4C)
{
    ...
    float field24[3]; // size 12, type 3, unk 0
    float field30[3]; // size 12, type 3, unk 0
    float field3C[4]; // size 16, type 3, unk 0
};
