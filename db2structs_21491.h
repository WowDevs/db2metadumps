...
struct ArtifactAppearanceRec // sizeof(0x28)
{
    char* field00; // size 1, type 2, flag 8
    ...
    DWORD field24; // size 1, type 0, flag 6
};
...
struct ArtifactRec // sizeof(0x15)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    char* field00; // size 1, type 2, flag 8
    DWORD field04; // size 1, type 0, flag 0
...
struct BattlePetAbilityEffectRec // sizeof(0x18)
{
    ...
    WORD field02; // size 1, type 5, flag 4
    WORD field04; // size 1, type 5, flag 4
    WORD field06[6]; // size 6, type 5, flag 0
    BYTE field12; // size 1, type 4, flag 4
    BYTE field13; // size 1, type 4, flag 4
    DWORD m_ID; // size 1, type 0, flag 2
};
...
struct BattlePetEffectPropertiesRec // sizeof(0x1F)
{
    //DWORD m_ID; // size 1, type 0, flag 0
...
struct BattlePetVisualRec // sizeof(0xD)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    char* field00; // size 1, type 2, flag 0
    WORD field04; // size 1, type 5, flag 4
...
struct BroadcastTextRec // sizeof(0x20)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    char* field00; // size 1, type 2, flag 8
    char* field04; // size 1, type 2, flag 8
...
struct CharShipmentContainerRec // sizeof(0x1E)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    char* field00; // size 1, type 2, flag 8
    char* field04; // size 1, type 2, flag 8
...
struct ChrRacesRec // sizeof(0x6E)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    char* field04; // size 1, type 2, flag 0
    ...
    WORD field5A; // size 1, type 5, flag 4
    ...
    BYTE field64; // size 1, type 4, flag 0
    BYTE field65; // size 1, type 4, flag 0
...
struct CreatureDisplayInfoCondRec // sizeof(0x3E)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    BYTE field04; // size 1, type 4, flag 0
    ...
    DWORD field22[3]; // size 3, type 0, flag 6
    DWORD field2E; // size 1, type 0, flag 2
    DWORD field32[3]; // size 3, type 0, flag 2
};
...
struct CriteriaTreeRec // sizeof(0x13)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    char* field04; // size 1, type 2, flag 8
...
// DecalProperties: 13 fields, flags 0, hash C7B7E435
struct DecalPropertiesRec // sizeof(0x2B)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    float field04; // size 1, type 3, flag 0
...
struct FactionRec // sizeof(0x49)
{
    ...
    BYTE field46; // size 1, type 4, flag 4
    BYTE field47; // size 1, type 4, flag 4
    BYTE field48; // size 1, type 4, flag 4
};
...
struct GarrBuildingRec // sizeof(0x3A)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    DWORD field04; // size 1, type 0, flag 0
...
struct GarrClassSpecPlayerCondRec // sizeof(0x11)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    char* field04; // size 1, type 2, flag 8
...
struct GarrEncounterRec // sizeof(0x19)
{
    DWORD field00; // size 1, type 0, flag 0
    char* field04; // size 1, type 2, flag 8
    float field08; // size 1, type 3, flag 0
...
struct GarrFollowerRec // sizeof(0x32)
{
    DWORD field00; // size 1, type 0, flag 0
    DWORD field04; // size 1, type 0, flag 0
    char* field08; // size 1, type 2, flag 8
...
struct GarrMissionRec // sizeof(0x4C)
{
    DWORD field00; // size 1, type 0, flag 0
    DWORD field04; // size 1, type 0, flag 4
    char* field08; // size 1, type 2, flag 8
    ...
    DWORD field44; // size 1, type 0, flag 6
    DWORD field48; // size 1, type 0, flag 6
};

// GarrMissionReward: 11 fields, flags 0, hash 8584C1F2
struct GarrMissionRewardRec // sizeof(0x17)
{
    DWORD field00; // size 1, type 0, flag 0
    DWORD field04; // size 1, type 0, flag 4
    WORD field08; // size 1, type 5, flag 4
...
struct GarrMissionTextureRec // sizeof(0x9)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    float field00[2]; // size 2, type 3, flag 0
    BYTE field08; // size 1, type 4, flag 4
...
struct GarrMissionTypeRec // sizeof(0x7)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    char* field00; // size 1, type 2, flag 8
    WORD field04; // size 1, type 5, flag 4
...
struct GarrSiteLevelRec // sizeof(0x13)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    float field00[2]; // size 2, type 3, flag 0
    WORD field08; // size 1, type 5, flag 4
...
struct GlueScreenEmoteRec // sizeof(0x9)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    WORD field00; // size 1, type 5, flag 4
    WORD field02; // size 1, type 5, flag 4
...
struct GlyphSlotRec // sizeof(0x5)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    BYTE field00; // size 1, type 4, flag 4
    DWORD field01; // size 1, type 0, flag 6
...
struct ItemAppearanceXUiCameraRec // sizeof(0x3)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    WORD field00; // size 1, type 5, flag 4
    BYTE field02; // size 1, type 4, flag 4
...
struct ItemDisplayXUiCameraRec // sizeof(0x5)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    BYTE field04; // size 1, type 4, flag 4
...
struct LfgDungeonsRec // sizeof(0x35)
{
    char* field00; // size 1, type 2, flag 8
    DWORD field04; // size 1, type 0, flag 4
    char* field08; // size 1, type 2, flag 0
...
struct QuestPOIBlobRec // sizeof(0x5)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    WORD field00; // size 1, type 5, flag 0
    WORD field02; // size 1, type 5, flag 4
...
struct QuestV2CliTaskRec // sizeof(0x32)
{
    DWORD field00; // size 1, type 0, flag 0
    char* field04; // size 1, type 2, flag 8
    char* field08; // size 1, type 2, flag 8
...
struct SpellShapeshiftFormRec // sizeof(0x2B)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    char* field00; // size 1, type 2, flag 8
    float field04; // size 1, type 3, flag 0
...
struct SpellTotemsRec // sizeof(0xE)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    DWORD field04[2]; // size 2, type 0, flag 0
...
struct SpellVisualRec // sizeof(0x70)
{
    ...
    WORD field62; // size 1, type 5, flag 4
    WORD field64; // size 1, type 5, flag 4
    WORD field66; // size 1, type 5, flag 4
    WORD field68; // size 1, type 5, flag 4
    BYTE field6A; // size 1, type 4, flag 0
    BYTE field6B; // size 1, type 4, flag 0
    DWORD field6C; // size 1, type 0, flag 6
};
...
struct VignetteRec // sizeof(0x16)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    char* field00; // size 1, type 2, flag 8
    float field04; // size 1, type 3, flag 0
...
struct WorldEffectRec // sizeof(0xB)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    DWORD field00; // size 1, type 0, flag 0
    WORD field04; // size 1, type 5, flag 4
...
struct WorldMapTransformsRec // sizeof(0x2D)
{
    //DWORD m_ID; // size 1, type 0, flag 0
...
struct LiquidTypeRec // sizeof(0xA5)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    char* field00; // size 1, type 2, flag 0
    DWORD field04; // size 1, type 0, flag 4
    ...
    BYTE field96; // size 1, type 4, flag 4
    BYTE field97; // size 1, type 4, flag 4
    BYTE field98; // size 1, type 4, flag 4
    BYTE field99; // size 1, type 4, flag 4
    BYTE field9A; // size 1, type 4, flag 4
    BYTE field9B[6]; // size 6, type 4, flag 4
    DWORD fieldA1; // size 1, type 0, flag 6
};
...
struct SoundKitAdvancedRec // sizeof(0x6A)
{
    //DWORD m_ID; // size 1, type 0, flag 0
    float field00; // size 1, type 3, flag 0
    DWORD field04; // size 1, type 0, flag 4
